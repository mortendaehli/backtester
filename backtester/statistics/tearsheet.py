...
from backtester.statistics import performance as perf
...
class TearsheetStatistics(Statistics):
    ...
    def _plot_equity(self, stats: dict, ax=None, **kwargs):
        """
    ...
    def _plot_rolling_sharpe(self, stats: dict, ax=None, **kwargs):
        """
    ...
    def _plot_drawdown(self, stats: dict, ax=None, **kwargs):
        """
    ...
    def _plot_monthly_returns(self, stats: dict, ax=None, **kwargs):
        """
    ...
    def _plot_yearly_returns(self, stats: dict, ax=None, **kwargs):
        """
    ...
    def _plot_txt_curve(self, stats: dict, ax=None):
        """
    ...
    def _plot_txt_trade(self, stats: dict, ax=None):
        """
    ...
    def _plot_txt_time(self, stats: dict, ax=None):
        """
    ...
    def save(self, filename: str = ""):
        raise NotImplementedError("This has not been implemented for this Tearsheet")
